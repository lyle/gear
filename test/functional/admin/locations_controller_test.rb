...
require 'admin/locations_controller'

# Re-raise errors caught by the controller.
class Admin::LocationsController; def rescue_action(e) raise e end; end

class Admin::LocationsControllerTest < Test::Unit::TestCase
  fixtures :locations
